<?php
// api.php - Full Version with Debugging
// Enable error reporting for debugging
ini_set('display_errors', 0); // Disable direct display to avoid breaking JSON
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        if ($action === 'fetch_all') {
            ...
            $response = [
             ...
             $response = ["status" => "error", "message" => "Invalid GET action"];
        }
    }
