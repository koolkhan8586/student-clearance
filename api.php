...
<body class="bg-gray-100 min-h-screen p-4 md:p-8 font-sans">
    ...
    <div class="max-w-7xl mx-auto container">
        ...
        <!-- Connection Status & Config (Improved Visibility) -->
        ...
        <div id="view-enrollment" class="tab-content hidden">
             <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                </tr></thead><tbody id="enrollmentTableBody"><tr><td colspan="6" class="p-4 text-center text-gray-500 italic">No records found.</td></tr></tbody></table></div>
            </div>
    ...
    <script>
        ...
        async function initData() {
            ...
            try {
                ...
                if (text.trim().startsWith('<')) {
                     ...
                     statusDiv.innerHTML = `
                        <div class="flex justify-between w-full items-center">
                            <span class="text-red-700 font-bold">⚠️ Connection Error: ${err}</span>
                            <div class="flex gap-2">
                ...
                statusDiv.innerHTML = `
                    <div class="flex justify-between w-full items-center">
                        <span class="text-red-700 font-bold">⚠️ DB Error: ${e.message}</span>
                        <div class="flex gap-2">
                             <button onclick="showConfigModal()" class="bg-white text-red-700 border border-red-300 px-3 py-1 rounded hover:bg-red-50 text-xs">Config</button>
                             <button onclick="showDebugModal()" class="bg-gray-200 text-gray-700 px-3 py-1 rounded text-xs">Debug</button>
                        </div>
        ...
        function renderAll() {
            ...
            // Update Counts
            document.getElementById('total_discounts_count').textContent = g_discounts.length;
